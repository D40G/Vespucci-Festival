...
--
Config.presets = {
	['1'] = {url = 'https://simulatorradio.stream/stream', title = 'Simulator Radio', filter = false, video = false}, --- SIMULATOR RADIO
	['2'] = {url = 'https://my-webradio.stream.laut.fm/my-webradio?t302=2020-10-31_15-27-02&uuid=9d502e7b-93db-4146-9f8b-3041d89fb6d6', title = 'NCS Radio', filter = false, video = false}, -- No Copyright Music Live Stream
	['3'] = {url = 'https://stream.live.vc.bbcmedia.co.uk/bbc_radio_one', title = 'BBC Radio One', filter = false, video = false}, --- BBC 1 RADIO LIVE
	['4'] = {url = 'https://stream.slam.nl/web11_mp3', title = 'SLAM! Hardstyle Radio', filter = false, video = false}, --- SLAM! HARDSTYLE RADIO
}
...
Config.defaultMediaPlayers = {
	...
	{
		position = vector3(-1426.9556884765626, -1347.4044189453126, 8.7348461151123),
